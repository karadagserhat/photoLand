        ...
        <div className="flex flex-row gap-4 lg:items-center justify-between mb-4 lg:mb-0">
          ...
          <div className="flex items-center gap-x-[10px]">
            ...
            >
              ...
              {/* amount */}
              <div className="bg-accent text-primary absolute w-[18px] h-[18px] rounded-full top-3 -right-1 text-[13px] flex justify-center items-center font-bold tracking-[-0.1rem]">
                {itemsAmount}
              </div>
            </div>
            {/* cart */}
